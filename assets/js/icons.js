/* ============================================================
   NOVEXA ERP — ICONS (icons.js)
   Inline SVG icon library (Feather-like, stroke-based)
   Usage:  Icon('dashboard', 20)  or  <i data-icon="dashboard"></i>
   ============================================================ */
(function (global) {
  'use strict';
  ...
  const PATHS = {
    ...
    truck: '<path d="M5 18a2 2 0 1 0 4 0 2 2 0 0 0-4 0z"/><path d="M15 18a2 2 0 1 0 4 0 2 2 0 0 0-4 0z"/><path d="M1 3h15v13H1z"/><path d="M16 8h4l3 3v5h-7"/>',
    ...
    'image-plus': '<path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7"/><line x1="16" y1="5" x2="22" y2="5"/><line x1="19" y1="2" x2="19" y2="8"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.5-3.5L8 21"/>',
    ...
    grid2: '<rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/>',
    ...
    corner: '<polyline points="9 18 15 12 9 6"/>',
    corner_l: '<polyline points="15 18 9 12 15 6"/>',
    ...
    maximize2: '<path d="M15 3h6v6"/><path d="M9 21H3v-6"/><path d="M21 3l-7 7"/><path d="M3 21l7-7"/>',
    ...
    'more-v': '<circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/>',
    barcode: '<line x1="4" y1="4" x2="4" y2="20"/><line x1="8" y1="4" x2="8" y2="20"/><line x1="11" y1="4" x2="11" y2="20"/><line x1="15" y1="4" x2="15" y2="20"/><line x1="18" y1="4" x2="18" y2="20"/><line x1="21" y1="4" x2="21" y2="20"/>',
    'image-plus': '<rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/><line x1="16" y1="3" x2="16" y2="9"/><line x1="13" y1="6" x2="19" y2="6"/>',
  ...
  function Icon(name, size, opts) {
    ...
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${s}" height="${s}" viewBox="0 0 24 24" fill="${fill}" stroke="${stroke}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${path}</svg>`;
  }

  // Replace all <i data-icon="name" data-size="20"></i> in the DOM
